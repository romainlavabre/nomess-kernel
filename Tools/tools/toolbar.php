...
<div id="nm_toolbar">
    <div class="nm_container-fluid nm_fixed-bottom" style="background: #333;">
        ...
        <div class="nm_btn-group nm_dropup">
            <button type="button" class="nm_btn nm_rouge nm_no-radius" data-toggle="dropdown" aria-haspopup="true"
                    aria-expanded="false">
                <?php
                echo (string)basename( $controller ) . ' - ' . (string)$method . ' - ' . $action; ?>
            </button>
        </div>
        <?php
        if( $tabOpcache !== NULL && isset( $tabOpcache['directives']['opcache.enable'] ) && $tabOpcache['directives']['opcache.enable'] ) {
            ?>
            <div class="nm_btn-group nm_dropup">
                <button type="button" class="nm_btn nm_noir nm_dropdown-toggle nm_no-radius" data-toggle="nm_dropdown"
                        aria-haspopup="true" aria-expanded="false">
                    OpCache <?php
                    echo 'enable'; ?>
                </button>
                <div class="nm_dropdown-menu">
                    <button class="nm_btn nm_dropdown-item nm_vert" style="cursor: pointer;" data-toggle="nm_modal"
        ...
        if( @ini_get_all( 'xdebug' )['xdebug.remote_enable']['local_value'] === '1' ) {
            ...
            <div class="nm_btn-group nm_dropup">
                ...
                <div class="nm_dropdown-menu">
                    <button class="nm_btn nm_dropdown-item nm_noir" style="color: white; cursor: pointer;"
                            data-toggle="nm_modal" data-target="#xdebug">Config
                    </button>
                    <?php
                    if( ini_get_all( 'xdebug' )['xdebug.profiler_enable']['local_value'] === '1' ) {
                        ?>
        ...
        <div style="float: right">
            ...
            <button class="nm_btn nm_bleu nm_no-radius">NoMess.<?php
                echo $version ?></button>
        </div>
    </div>
    ...
    try {
        if( $tabOpcache !== NULL && $tabOpcache['directives']['opcache.enable'] ) {
            ?>
            <div class="nm_modal fade" id="cache" tabindex="-1" role="dialog" aria-labelledby="examplenm_modalLabel"
                 aria-hidden="true">
                <div class="nm_modal-dialog nm_modal-lg" role="document">
                    <div class="nm_modal-content nm_no-radius">
                        ...
                        <div class="nm_modal-body">
                            <div class="nm_container">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nm_a nav-link active" style="color: #333;" id="home-tab"
                                           data-toggle="tab" href="#stat" role="tab" aria-controls="home"
                                           aria-selected="true">Statistiques</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nm_a nav-link" style="color: #333;" id="profile-tab" data-toggle="tab"
                                           href="#profile" role="tab" aria-controls="profile" aria-selected="false">Cache</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nm_a nav-link" style="color: #333;" id="contact-tab" data-toggle="tab"
                                           href="#contact" role="tab" aria-controls="contact" aria-selected="false">Configuration</a>
                                    </li>
                                </ul>
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" style="color: #333;" id="stat"
                                        ...
                                        <table class="nm_table nm_table-dark">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php
                                                    echo $tabStatus['opcache_statistics']['num_cached_scripts']; ?> -
                                                    (<?php
                                                    echo number_format( ( ( 100 * $tabStatus['opcache_statistics']['num_cached_scripts'] ) / $tabOpcache['directives']['opcache.max_accelerated_files'] ), 2, ',', '' ); ?>
                                                    %)
                                                </td>
                                                <td><?php
                                                    echo $tabOpcache['directives']['opcache.max_accelerated_files']; ?></td>
                                            </tr>
                                            <tr>
                                                <th>Clef en cache</th>
                                                <td><?php
                                                    echo $tabStatus['opcache_statistics']['num_cached_keys']; ?> -
                                                    (<?php
                                                    echo number_format( ( ( 100 * $tabStatus['opcache_statistics']['num_cached_keys'] ) / $tabStatus['opcache_statistics']['max_cached_keys'] ), 2, ',', '' ); ?>
                                                    %)
                                                </td>
                                                <td>/<?php
                                                    echo $tabStatus['opcache_statistics']['max_cached_keys']; ?></td>
                                            </tr>
                                            <tr>
                                                <th>Mémoire utilisé</th>
                                                <td><?php
                                                    echo $tabStatus['memory_usage']['used_memory']; ?> - (<?php
                                                    echo number_format( ( ( 100 * $tabStatus['memory_usage']['used_memory'] ) / ( $tabStatus['memory_usage']['free_memory'] + $tabStatus['memory_usage']['used_memory'] ) ), 2, ',', '' ); ?>
                                                    %)
                                                </td>
                                                <td>/<?php
                                                    echo $tabStatus['memory_usage']['free_memory'] + $tabStatus['memory_usage']['used_memory']; ?></td>
                                            </tr>
                                            <tr>
                                                <th>Clef en cache</th>
                                                <td><?php
                                                    echo $tabStatus['opcache_statistics']['num_cached_keys']; ?></td>
                                                <td>/<?php
                                                    echo $tabStatus['opcache_statistics']['max_cached_keys']; ?></td>
                                            </tr>
                                            </tbody>
                        ...
                        <div class="nm_modal-footer">
                            <button type="button" class="nm_btn nm_btn-secondary nm_no-radius" data-dismiss="nm_modal">
                                Fermer
                            </button>
                        </div>
                    </div>
    ...
    if( @ini_get_all( 'xdebug' )['xdebug.remote_enable']['local_value'] === '1' ) {
        ?>
        <div class="nm_modal fade" id="xdebug" tabindex="-1" role="dialog" aria-labelledby="examplenm_modalLabel"
             aria-hidden="true">
                    ...
                    <div class="nm_modal-body">
                        <div class="nm_container">
                            <div class="nm_tab-content" id="myTabContent">
                                <div class="nm_tab-pane fade show nm_active" style="color: #333;" id="stat"
                                     role="nm_tabpanel" aria-labelledby="home-tab">
                                    <table class="nm_table nm_table-dark">
                                        <thead>
                                        <tr>
                                        ...
                                        foreach( ini_get_all( 'xdebug' ) as $key => $value ) {
                                            ...
                                            <tr>
                                                <th><?php
                                                    echo $key; ?></th>
                                                <td><?php
                                                    echo $value['local_value']; ?></td>
                                                <td><?php
                                                    echo $value['global_value']; ?></td>
                                            </tr>
                                            <?php
                                        } ?>
                                        </tbody>
    ...
    ?>
    <div class="nm_modal fade" id="report" tabindex="-1" role="dialog" aria-labelledby="examplenm_modalLabel"
         aria-hidden="true">
        <div class="nm_modal-dialog nm_modal-lg" role="nm_document">
            <div class="nm_modal-content nm_no-radius">
                <div class="nm_modal-header nm_rouge nm_no-radius">
                ...
                <div class="nm_modal-footer">
                    <button type="button" class="nm_btn nm_btn-secondary nm_no-radius" data-dismiss="nm_modal">Fermer
                    </button>
                </div>
            </div>
        </div>
