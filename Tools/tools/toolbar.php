...
<script type="text/javascript" src="<?php echo str_replace('public/', '',WEBROOT) . 'toolbar/popper.min.js'; ?>"></script>
<script type="text/javascript" src="<?php echo str_replace('public/', '',WEBROOT) . 'toolbar/bootstrap.js'; ?>"></script>